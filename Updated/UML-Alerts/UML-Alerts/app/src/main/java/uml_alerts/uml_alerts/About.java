...
public class About extends ActionBarActivity {
    ...
    public void viewLocation() {
        ...
        // Launches a new activity.
        Intent myIntent = new Intent(About.this, Location.class);
        //myIntent.putExtra("key", value); //Optional parameters
        About.this.startActivity(myIntent);
    }
    ...
    public void viewAlerts() {
        ...
        // Launches a new activity.
        Intent myIntent = new Intent(About.this, Alerts.class);
        //myIntent.putExtra("key", value); //Optional parameters
        About.this.startActivity(myIntent);
    }
    ...
    public void viewContacts() {
        ...
        // Launches a new activity.
        Intent myIntent = new Intent(About.this, Contacts.class);
        //myIntent.putExtra("key", value); //Optional parameters
        About.this.startActivity(myIntent);
    }
    ...
    public void viewOtherSettings() {
        ...
        // Launches a new activity.
        Intent myIntent = new Intent(About.this, OtherSettings.class);
        //myIntent.putExtra("key", value); //Optional parameters
        About.this.startActivity(myIntent);
    }
}
